...
try:
    ...
    cv2.imwrite('C:/Source Codes/OpenCV3_beginner/images/or.jpg',dst)
    cv2.imshow('dst1',dst)

    img_mask = cv2.imread('C:/Source Codes/OpenCV3_beginner/images/mask.bmp',cv2.IMREAD_GRAYSCALE)
    dst = cv2.bitwise_or(img2,img2,img1,img_mask)
    cv2.imwrite('C:/Source Codes/OpenCV3_beginner/images/orMask.jpg',dst)
    cv2.imshow('dst2',dst)
